...
const NON_REASONING_MODELS: Record<string, Model> = {
  ...
  "14B": { id: "together/deepseek-r1-distill-14b", name: "DeepSeek R1 Distill 14B", costPer1k: 0.0002, expectedLatency: "medium", reasoningDepth: "none", expectedAccuracy: "good" },
