    ...
    <TooltipProvider>
      <div className="bg-white text-gray-900">
        <div className="w-full px-4 sm:px-[72px] pt-4 sm:pt-6 pb-4">
                      ...
                      return (
                        <Tooltip key={col}>
                          <TooltipTrigger asChild>
                            <div className={`p-3 min-h-[150px] flex flex-col items-center justify-center bg-gray-50 ${col !== 'Frontier' ? 'border-r border-gray-200' : ''}`}>
          ...
          <div className="mt-4 py-2 text-center text-xs sm:text-sm text-gray-500">
