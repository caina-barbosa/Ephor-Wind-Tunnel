...
export default function ChatPage() {
  ...
  return (
    <TooltipProvider>
      <div className="bg-white text-gray-900 min-h-[100dvh] flex flex-col">
        <div className="w-full px-4 sm:px-[72px] pt-4 sm:pt-6 pb-0 flex-1 flex flex-col">
          ...
          <div className="mt-auto py-2 text-center text-xs sm:text-sm text-gray-500">
